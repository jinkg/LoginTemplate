...
import com.idsmanager.oauthclient.fragment.LoginFragment;
import com.idsmanager.oauthclient.fragment.RegisterFragment;
import com.idsmanager.oauthclient.fragment.TokenLoginFragment;
...
public class AccountActivity extends RevealBackgroundActivity implements LoginFragment.LoginSuccessCallback {
    ...
    public void addContent(OpenType type) {
        ...
        switch (type) {
            case Register:
                transaction.add(R.id.rl_content, RegisterFragment.getInstance(this))
                        .addToBackStack(null)
                        .commit();
                break;
            case TokenLogin:
